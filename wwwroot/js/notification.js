...
//    notificationBox.className = 'fixed top-4 right-4 bg-blue-500 text-white px-4 py-2 rounded-lg shadow-lg z-50 transform transition-all duration-300';
...
//        showSystemNotification(notification.content);
//    } else {
